...
- [x] Add source-label, review-explanation, policy-summary, and safety-note helpers for Chat social proposals.
- [x] Show those fields in the Chat social-event row and selected detail card.
- [x] Add a runtime greeting test that expects `Foreground event tick`, conservative greeting copy, and policy snapshot text.
- [x] Expand the existing high-risk AI proposal test to expect `Chat AI response` and review-first safety copy.
...
- [x] Record that World Hub now explains generated Chat proposal sources and review boundaries.
- [x] Keep future work focused on richer scheduling and high-risk behavior only after explanation surfaces remain clear.

### Task 3: Validate And Commit

- [x] Run `git diff --check`.
- [x] Run focused tests for Control Center and Chat social runtime source.
