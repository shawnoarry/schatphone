...
4. `P1 IN_PROGRESS`: the explicit custom role -> Chat half plus the user-promoted Wallet exact-money and card-pack foundations are done; next prove one ordinary life-consequence flow, with default Home release curation reviewed as a product choice.
