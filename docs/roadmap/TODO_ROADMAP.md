...
Status: `P0 IN_PROGRESS / CMG-00, CMG-01, CMG-02, CMG-03, AND DCF-05 DONE 2026-08-20 / DCF-03, CMG-04, AND CMG-05 DONE 2026-08-21`
...
1. `P0 IN_PROGRESS / CMG-00, CMG-01, CMG-02, CMG-03, AND DCF-05 DONE 2026-08-20 / DCF-03, CMG-04, AND CMG-05 DONE 2026-08-21`: the first production gift shared-experience vertical is complete at `d8662cb`. `CMG-06` is the next ordered slice, but it requires a new exact storage/migration/rollback reservation before any 500-row retention change. `CMG-07`, `CMG-08`, and `DCF-06` remain separately assignable only after their own non-overlapping reservations.
