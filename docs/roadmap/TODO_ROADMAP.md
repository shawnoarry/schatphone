...
1. `P0 IN_PROGRESS / CMG-00 THROUGH CMG-09 DONE / DCF-01 THROUGH DCF-06 DONE / CMG-10 NEXT`: `CMG-09` is integrated at `3126c1c` with bounded Contacts/World Hub paging and Chat continuity projections, unchanged storage shapes, and no history deletion. `CMG-10` is now dependency-unblocked but remains a separate migration/recovery slice.
