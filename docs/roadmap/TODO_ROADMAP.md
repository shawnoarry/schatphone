...
Status: `P0 IN_PROGRESS / CMG-00, CMG-01, CMG-02, CMG-03, AND DCF-05 DONE 2026-08-20 / DCF-03 AND CMG-04 DONE 2026-08-21`
...
1. `P0 IN_PROGRESS / CMG-00, CMG-01, CMG-02, CMG-03, AND DCF-05 DONE 2026-08-20 / DCF-03 AND CMG-04 DONE 2026-08-21 / NO ACTIVE RESERVATION`: `CMG-05` may now be claimed as the next dependency-safe shared-experience slice. `CMG-08` and `DCF-06` also remain independently assignable on non-overlapping paths. Every PC must first record the selected item as `IN_PROGRESS`, its exact base, machine, worktree, and reserved paths before editing.
