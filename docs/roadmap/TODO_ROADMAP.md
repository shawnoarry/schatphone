...
1. `P0 IN_PROGRESS / CMG-00, CMG-01, CMG-02, CMG-03, AND DCF-05 DONE 2026-08-20 / DCF-01, DCF-03, CMG-04, CMG-05, CMG-06, CMG-07, AND DCF-02 DONE 2026-08-21`: the first production gift shared-experience vertical is complete at `d8662cb`; `CMG-06` is complete at `f9f14f9`, `CMG-07` is complete at `d8b46fc` on the Event Instance V2 retention/migration/rollback paths, `DCF-02` is complete at `8ff85c7` on the Chat CSS import boundary, and `DCF-01` is complete at `4654e02` on the WorldBook multi-entry navigation boundary. `CMG-08`, `DCF-04`, and `DCF-06` remain separately assignable only after their own non-overlapping reservations.
