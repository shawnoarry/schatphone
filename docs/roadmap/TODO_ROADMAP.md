...
Working tree: local tool caches and QA/visual artifacts are preserved and excluded from integrated capability claims.
...
- 4.17 is the P0 Contacts V3 Identity And Role Core lane. `CONTACTS-V3-0` and `CONTACTS-V3-1` completed the owner foundation; V3-2A completed the category/field/person-type card path; `PERSONA-1` and `PERSONA-2` completed review-only classification plus one rollback-safe confirmed profile revision; `CONTACTS-V3-3` completed bounded formal Chat, read-only Event identity, and Work Hub matching projections; `CONTACTS-V3-4A` completed the compatibility-safe archive/restore foundation; `CONTACTS-V3-4B` completed the internal archive-first permanent-delete coordinator; and `CONTACTS-V3-4C` completed the bounded user-facing lifecycle flow on 2026-08-28. V3-5 consumer adoption remains gated;
...
- 4.12 is `PARTIAL_DONE / CALENDAR_DEPARTURE_READINESS_V1_DONE 2026-08-15 / CJA-1_DONE 2026-08-15 / CJA-2_DONE 2026-08-16 / CJA-3_DONE 2026-08-16 / CJA-4_DONE 2026-08-16 / CJA-5_DONE 2026-08-16 / CJA-6A_CONTRACT_DONE 2026-08-17 / EVT-WORK-4_EXECUTION_PROOF_DONE 2026-08-30 / CJA-6B_EVT-CHRONICLE-1_DONE 2026-08-30`: Calendar supports Month/Week/Agenda and stable Map destinations; Schedule Orchestrator V2, Agenda Journey V2, Map V5, and Activity Session V3 carry a production Work Hub execution revision through explicit Save, departure, arrival, and activity start. Chronicle adds a separate schema-V1 Diary Owner and a finite deterministic projection over verified owner summaries without persisting a second timeline or calling a model. Appointment auto-entry, inferred attendance/completion, media callers/richer companions, AI recall, and CJA-6C remain separately gated.
...
- 4.14 is `P1 PARTIAL_DONE / EVE-4B REFERENCE_VERTICAL_DONE / EVE-4C DONE 2026-08-14 / PLAYER_CONTEXT_V1_FOUNDATION_DONE 2026-08-15 / EVENT_REASON_COPY_AND_FEEDBACK_MAINTENANCE_DONE / EVENT_POLICY_V1_DONE 2026-08-29 / EVENT_SETTINGS_V1_DONE 2026-08-29 / WORLD_SEMANTIC_FOUNDATION_AND_W2_DONE 2026-08-29 / WORLD-SEMANTIC-4 DONE 2026-08-31 / EVENT-PREP-1 DOC_ONLY_DONE 2026-08-27 / EVENT-PROJECTION-1 READ_ONLY_DONE 2026-08-27 / EVT-WORK-1 DONE 2026-08-29 / EVT-WORK-2 DONE 2026-08-29 / EVT-WORK-3 DONE 2026-08-30 / EVT-WORK-4 DONE 2026-08-30 / EVT-CHRONICLE-1 DONE 2026-08-30`: Event is a cross-module causal chain, not a universal card system. Production Work Hub independently validates world-neutral organization authority and carries one schedule-change family through explicit Calendar/Agenda/Map/Activity owner actions. Chronicle reviews that chain through verified bounded summaries while owning only user-authored diary records. The first arbitrary-world runtime proof now lets Map validate one authored restricted-place concept against Work Hub membership/role concepts through the confirmed semantic version and settle one durable Event Instance V2 result. Modern K-pop, magic academy, and Tide Contract City use the same engine path; K-pop remains fixture content. W3 switching, AI recall, SMS, downstream consequences, background model operation, and any later event lane remain separately gated.
...
- 4.16 is `P1 INITIAL_SHELL_PORTFOLIO_DONE / SHP-1 THROUGH SHP-11 S1_DONE 2026-08-24 / WORKPLACE_S1_PREVIEW_RETAINED / WORK_HUB_EVT-WORK-1_THROUGH_4_DONE 2026-08-30 / EVT-CHRONICLE-1_DONE 2026-08-30`: the accepted shell-first wave includes thirteen installed S1 Apps plus the native-system Notification Center. Workplace's K-pop fixture remains an explicit non-authoritative preview; it is not the production Work Hub. Production Work Hub has world/profile-bound organization authority and revision-safe execution proof. Chronicle is now a separate ordinary Home/App Store product with its own Diary Owner and derived projection. No K-pop-specific production permission path exists; NEXT stays external-opportunity-only and SMS stays conditional.
...
4. `P1 Unified world-setting identity` - `STAGE_W1_DONE / STAGE_W2_DONE 2026-08-29 / STAGE_W3_GATED`
   ...
   - `DONE 2026-08-29`: one canonical `world_local_primary` identity, exact source snapshots, immutable reviewed/compiled semantic versions, active/previous/candidate pointers, activation history, and rollback persist in the existing System user carrier and required complete-backup section;
   - `DONE 2026-08-29`: known legacy/Pack-shaped profile-template aliases migrate deterministically, malformed version records or pointers reject restore before mutation, and new Event Instance V1/V2 records retain their first-start semantic binding;
   - `DONE 2026-08-30`: `EVT-WORK-3` consumes the stable first-start world/version binding for one production world-neutral organization event family without automatic model calls or owner truth from model output;
   - W3 multiple-world definitions/switching and automatic background recompilation remain separate gates.
...
Status: `P0 DONE / CMG-00 THROUGH CMG-10 AND DCF-01 THROUGH DCF-06 COMPLETE 2026-08-28`
...
| `CMG-08` | P0 | `DONE 2026-08-27` | Mini Scene now splits memory-only presentation from explicit receipt-gated retention; retained occurrences reopen before provider calls, explicit regeneration uses a new request/revision, V1 artifacts migrate as retained, and the 120-artifact truncation is removed. World Hub pages and filters saved/archived scenes with open/archive/restore/confirmed-delete actions; save and management failures roll back or keep the temporary scene retryable without changing source event, memory, diary/timeline, or owner audit truth. Focused coverage passes 5 files / 23 tests; dedicated desktop Chromium plus simulated Pixel 5 E2E passes 2/2 in Chinese day and English night modes with attached screenshots and no overflow. The shared checkout passes full lint, 338 Vitest files / 2543 tests, the 705-module production build, governance 19/19, and diff checks. No physical-device claim. | `CMG-02` | module architecture + Event Runtime |
| `CMG-09` | P0 | `DONE 2026-08-28` | Completed in integration commit `3126c1c`. Relationship Runtime indexes memories by person and Mini Scene indexes retained scenes by state while preserving every owner record and existing storage shape. Contacts/World Hub reads return only the requested page; Chat receives one current relationship projection, at most 3 relevant role memories / 720 characters, and at most 2 non-archived shared-experience summaries / 480 characters, deduplicated by stable experience ID. Raw recent relationship events, source modules/IDs, and supporting-record counts stay out of prompts. Focused coverage passes 6 files / 56 tests; real shared-experience consumer coverage passes 5 files / 38 tests; full Vitest passes 340 files / 2571 tests; lint, the 706-module production build, governance 19/19, and diff checks pass. No route or UI changed, so no new E2E path was required. | `CMG-03` through `CMG-08` | module architecture + all consumers / PC-A |
| `CMG-10` | P0 | `DONE 2026-08-28` | Completed by `98f1250`. Relationship Runtime V3 reads V1/V2/V3 carriers and reports rejected or ungrouped legacy rows without inventing `memoryKey` or `sharedExperienceId`; valid ungrouped rows remain owner history but do not enter a false memory group. One verified complete-backup fixture jointly preserves 501 relationship rows, 241 Event Instances, and 125 retained/archived Mini Scenes through restore, persistence, and reopen. The full Shopping gift journey also rebuilds after owner snapshots restore with three progress stages, five owner-reference classes, and one relationship memory. Existing save-failure rollback tests remain green. Focused coverage passes 7 files / 54 tests; full Vitest passes 341 files / 2573 tests; lint, the 706-module build, governance 19/19, and diff checks pass. Rows already discarded by older builds remain unrecoverable and are not claimed back. No route or UI changed. | `CMG-06` through `CMG-09` | module architecture / controller PC |
...
4. `P1 Hosted product proof` - `IN_PROGRESS / AUTOMATED_HOSTED_BROWSER_PROOF_REMOTE_DONE / FOUR_SHARD_RELEASE_GATE_REMOTE_DONE 2026-09-01`
   - exact-commit CI, Pages, and post-deploy browser jobs are remotely proven; external required-check/environment policy remains a separate permission-gated verification;
   - deployed base-path, manifest/installability metadata, controlled online-to-offline reload/reopen, and complete backup export/import/reopen are browser-proven; OS installation/relaunch, named physical devices, and credential-bearing hosted-provider Chat remain separate evidence;
   - `AUTOMATED_BASELINE IMPLEMENTED 2026-08-31` at `38dc329`: GitHub builds emit `release.json` with the exact source commit, successful Pages runs trigger a separate Hosted Product Proof workflow, and an isolated Playwright configuration verifies the deployed `/schatphone/` base, resolved manifest ID/start URL/scope/icons, Service Worker control/cache, online-to-offline reload plus a second offline page, and a complete Settings backup exported from persisted owner data, restored into blank browser storage, and reopened with a completed recovery journal. Chromium may report no installability error or one environment-only `in-incognito` result; zero product errors remain required, and browser automation is not relabeled OS installation. Exact evidence is recorded in `docs/qa/HOSTED_PRODUCT_PROOF_2026-08-31.md`;
   - `FOUR_SHARD_RELEASE_GATE REMOTE_DONE 2026-09-01`: final Pages run `33504446970` and manually dispatched CI run `33505937702` both evaluated exact revision `8d38dfa8c62a60687407d2e61659d9078cc023bc`, passed audits, the 1,220-asset publication inventory, lint, full Vitest, the 733-module build, and all four one-worker fail-closed full-product E2E shards. Pages deployed only after the full matrix; the live `release.json` reported the same complete SHA;
   - `AUTOMATED_HOSTED_BROWSER_PROOF REMOTE_DONE 2026-09-01`: automatic run `33505769229` checked out the exact deployed revision and passed 4/4 across desktop Chromium and simulated Pixel 5 for the `/schatphone/` base, manifest/installability metadata, Service Worker control/cache, online-to-offline reload/reopen, and complete backup export -> blank-storage restore -> reopen. This closes the credential-free automated browser slice only; external protection policy, OS installation/relaunch, named physical devices, and hosted-provider credential evidence remain separate;
...
5. `P2 Post-preview depth` - `PARTIAL_DONE`
   ...
   - personal R2, production push, Gallery schema, non-Book Repository migrations, World Setting W3 switching, hotspot decomposition, broad typing, and secondary-app depth do not block the first usable product preview; the user-promoted W2 single-world identity/version slice is complete.
...
Status: `PARTIAL_DONE / CALENDAR_DEPARTURE_READINESS_V1_DONE 2026-08-15 / CJA-1_DONE 2026-08-15 / CJA-2_DONE 2026-08-16 / CJA-3_DONE 2026-08-16 / CJA-4_DONE 2026-08-16 / CJA-5_DONE 2026-08-16 / CJA-6A_CONTRACT_DONE 2026-08-17 / EVT-WORK-4_EXECUTION_PROOF_DONE 2026-08-30 / CJA-6B_EVT-CHRONICLE-1_DONE 2026-08-30`
...
- `EVT-WORK-4` requires exact production Work Hub authority/runtime/receipt/owner-fact/Calendar lineage before materialization, carries one execution revision through Schedule Orchestrator V2, Agenda Journey V2, Map V5, and Activity Session V3, and emits one exact Agenda notification per revision. Explicit Save, departure, arrival, and activity start remain separate user/owner actions; stale revisions fail closed.
- `生活志 / Chronicle` is the ordinary Home/App Store product for personal continuity. Its schema-V1 Diary Owner persists only user-authored entries, while its finite Narrative Timeline is rebuilt deterministically from verified owner summaries and typed source references. Broken diary links retain the user's prose and show unavailable state; invalid projected sources fail closed. Chronicle cannot edit Calendar, Work Hub, Agenda Journey, Map, Activity Session, Event Runtime, Wallet, relationship, or public truth, and ordinary reads require no model.
...
8. `EVT-WORK-4 DONE 2026-08-30`: production Work Hub schedule changes now require exact execution proof after explicit Calendar Save; Schedule Orchestrator V2, Agenda Journey V2, Map V5, Activity Session V3, and Notification Center preserve the accepted revision through explicit departure, arrival, and activity start with migration, backup, rollback, notification dedupe, and stale-revision rejection. Focused execution coverage passes 10 files / 56 tests, focused backup coverage passes 1 file / 8 tests, the full suite passes 352 files / 2725 tests, and desktop Chromium plus simulated Pixel 5 production E2E passes 4/4. No physical-device or closed-page execution proof is claimed.
9. `CJA-6B / EVT-CHRONICLE-1 DONE 2026-08-30`: `生活志 / Chronicle` now has an independent schema-V1 Diary Owner, stable entry IDs, create/edit/delete, moods/tags/typed source links, rollback-safe layered persistence, complete-backup V7 support with V3-V6 compatibility, and a finite deterministic projection over verified Work Hub, Calendar, Agenda Journey, Map, and Activity Session records. The ordinary Home/App Store route provides day/recent/source review, diary editor/detail, source deep links, broken-link presentation, return context, bilingual day/zen layouts, accessibility, and desktop/simulated Pixel 5 coverage. AI recall, automatic diary writing, free-text fact extraction, Wallet/Assets/relationship/public consequences, W3 switching, and CJA-6C remain unimplemented.
...
25. `WORK_HUB_FIRST_NEXT_EVENT_DIRECTION_ACCEPTED 2026-08-26 / EVT-WORK-1_AND_2_DONE 2026-08-29 / EVT-WORK-3_AND_4_DONE 2026-08-30 / EVT-CHRONICLE-1_DONE 2026-08-30`: the former NEXT-first career appointment plan remains superseded. Production Work Hub owns validated work inside an existing organization and supports the ordinary non-event loop plus one world-neutral schedule-change event family without AI dependency. Exact authority and source revisions gate the event; Work Hub owns explicit decisions and durable results; Calendar alone confirms a revised time; Agenda Journey, Map, and Activity Session preserve the accepted execution revision through explicit execution. `生活志 / Chronicle` reads that owner-confirmed chain through a finite deterministic projection and keeps user diary prose under its own Diary Owner. The old K-pop Workplace fixture remains an explicit preview and cannot grant authority. `NEXT / 机会` continues to own public jobs, external auditions/casting, headhunting, and cross-organization invitations. Messages/SMS remains conditional. This completion did not itself authorize a later lane; the separately authorized and completed `WORLD-SEMANTIC-4` proof is recorded below.
26. `EVENT_POLICY_V1_DONE 2026-08-29`: `src/lib/simulation/event-policy.js` is the shared optional-event policy Interface for module permission, random-event intensity, event-family probability, and presentation mode. Activity Session, the retained Map Journey compatibility Adapter, and the production Map place invitation now read those settings through it without changing their accepted probabilities or no-event behavior. New event logs and the durable Activity Session/Map Journey pilot records retain normalized policy snapshots; legacy records remain valid with no migration. Outcome mode, consequence severity, reroll, pause-all, and interactive HTML remain separate later controls and must not receive enabled Settings UI before their runtime contracts exist.
27. `EVENT_SETTINGS_V1_DONE 2026-08-29`: Settings now has a dedicated mobile-first `事件 / Events` page for the implemented persisted frequency, module-permission, supported-presentation, Mini Scene, and foreground-check controls. UI-to-policy regression proves the frequency and Map permission inputs change Event Policy allow/block behavior and probability. AI Automation no longer duplicates event controls; unsupported result rewrite, severity, reroll, pause-all, and interactive HTML remain absent.
28. `EVENT_SETTLEMENT_V1_DONE 2026-08-29`: the lightweight Map development event now proves a complete one-occurrence settlement loop without changing the frozen Event Instance V1 contract. One stable preview instance receives one d100 roll, persists its selected choice/outcome/consequence/timestamps and a linked Simulation settlement receipt, and reopens read-only with the exact same result after refresh. Repeated resolution cannot reroll or duplicate the log, development records cannot become production invitations/pins, and `canonicalMutation: none` remains explicit. This does not add player-value effects, reroll Settings, or a new production event family.
29. `WORLD_SEMANTIC_SETTINGS_PREVIEW_DONE 2026-08-29 / FOUNDATION_DIRECTION_ACCEPTED`: `Settings > World Setup` shows what local code can read from the active world in ordinary user language and offers one explicit check through the existing Network & API provider configuration. Invalid schema fails closed; the result preserves concepts, candidate capabilities, boundaries, unknowns, conflicts, confidence, and provenance in memory only until the user explicitly selects `Use this version`. Opening Settings or the subpage performs no call. World Hub remains hidden by default and retains advanced world-usage evidence rather than initial preparation or a model button. Modern K-pop realism, magic academy, and a radically different custom world are equal conformance fixtures.
30. `WORLD_SEMANTIC_PROPOSAL_COMPILER_CONTRACT_DONE 2026-08-29`: the versioned provider-neutral proposal, separate model receipt, exact user-confirmation seam, source/proposal hashes, generic runtime registry, and deterministic immutable compiler receipt are implemented as pure modules. Invalid/duplicate IDs, dangling references/bridges, unsupported runtime capabilities, ownerless or unsupported effects, blocking unknowns, unresolved conflicts, stale confirmation hashes, and non-user confirmation fail closed. Modern K-pop realism, magic academy, and Tide Contract City compile through one identical registry/compiler path and retain their own terminology. The pure compiler retains no Store, persistence, provider caller, owner mutation, genre branch, or Event Runtime registration.
31. `WORLD_SETTING_W2_DONE 2026-08-29`: the existing System user carrier now persists one canonical `world_local_primary` identity, source snapshots/fingerprints, immutable reviewed/compiled semantic versions, active/previous/candidate pointers, activation history, and rollback. Model review remains transient until explicit user confirmation; source changes never auto-call or auto-activate; activation revalidates deterministic evidence and waits for layered persistence; failed primary persistence keeps the prior version. Known legacy/Pack-shaped profile-template scopes migrate to the canonical ID, malformed restored pointers fail before current-state mutation, and complete backup inventories the WorldBook-owned identity/version class. New Event Instance V1/V2 records retain the active version at first creation, so later updates or rollback affect future records only. Desktop Chromium and simulated Pixel 5 pass check, activation, reload, accessibility, and overflow coverage. `EVT-WORK-3` now consumes this binding for one production world-neutral organization event family; W3 switching, background model operation, and model-authored owner truth remain gated.
32. `WORLD-SEMANTIC-4 DONE 2026-08-31`: the first arbitrary-world runtime proof connects confirmed semantic versions to one fully playable restricted-place entry chain. Authored Map places declare semantic concept IDs; current Work Hub membership/roles expose bounded semantic concept evidence; the generic resolver matches both through `runtime:access:restricted_place`; Event Runtime creates one stable Event Instance V2 and one Map owner request; Map writes the correlated owner fact; Runtime settles one durable `routine` or `reviewed` result; only a granted result creates the existing Map place session. Missing, stale, or mismatched world/identity evidence fails closed with native Map feedback and a Settings return path. Ordinary unannotated places stay on the existing zero-event path. The instance identity binds world version, map, place, and position evidence, so refresh, reopen, repeated taps, and complete backup restore reuse the same result; later world-rule activation affects new events only. Modern K-pop, magic academy, and Tide Contract City pass the same Store/runtime path with no genre branch. AI is not called during play and cannot grant access, create membership, select randomness, write owner facts, or override denial. Settings remains the normal preparation surface; World Hub remains hidden advanced audit. This does not authorize W3 switching, automatic recompilation, closed-page autonomy, type-specific runtime branches, or another event family.
...
Status: `P1 INITIAL_SHELL_PORTFOLIO_DONE / SHP-1 MAIL / SHP-1B MAIL_AI_ARRIVAL / SHP-2 BROWSER_COMMUNITY_HEALTHCARE_HOUSING / SHP-3 NOTIFICATION / SHP-4 WORKPLACE_S1_PREVIEW / SHP-5 FANDOM / SHP-6 TICKETS / SHP-7 TRAVEL / SHP-8 INTERCITY / SHP-9 CREATOR_RIGHTS / SHP-10 PARCEL / SHP-11 CAREER DONE 2026-08-24 / WORK_HUB_EVT-WORK-1_THROUGH_4_DONE 2026-08-30 / EVT-CHRONICLE-1_DONE 2026-08-30`
...
- `NEXT_EVENT_PRODUCTION_PLAN_AFTER_SHELL_PORTFOLIO.md` records `EVT-WORK-1` through `EVT-WORK-4` and `EVT-CHRONICLE-1` complete: production organization authority, the ordinary Work Hub loop, the world-neutral schedule-change event, revision-safe Calendar/Agenda/Map/Activity execution proof, and the bounded personal Chronicle now exist, while the S1 K-pop fixture stays an explicit preview. Calendar still requires explicit review and Save; departure, arrival, and activity start remain explicit owner actions. `NEXT / 机会` participates only for external opportunities. Messages/SMS remains conditional, and no later event-lane candidate is promoted by this completion.
...
8. `CONTACTS-V3-2C PERSON_PROFILE_UX IN PROGRESS`: the person-first readable overview, grouped confirmed fields, user-language second-level editor/review, category choice for proposed fields, and untouched Eva/Jackie representative fixtures are landed locally for joint product review. The latest refinement establishes the stable `roleId` as prominent contact identity and makes it immutable after creation at both UI and Contacts Profile Owner boundaries; makes the person image open a dedicated Appearance sheet; reuses Gallery import/person tags/person albums for confirmed image references; and keeps basic identity editing separate from avatar and whole-persona authoring. Camera and Gallery links do not claim automatic capture return, face recognition, or image generation. The overview retains one `Import persona` entry plus the secondary manual form, removes the duplicate second-level import action, and accepts pasted text or local TXT/Markdown/JSON as review-only source. Invalid, empty, oversized, unsupported, or unreadable files preserve the prior source and canonical profile. Existing Chat, relationship, memory, lifecycle, backup, and save behavior remains preserved; do not claim the full Contacts visual redesign complete before user acceptance;
...
- V3-2A/V3-2B keep every world suggestion, custom field, and free-text classification editable and unsaved until explicit confirmation; one confirmation writes one Contacts-owned revision and restores the complete prior profile on persistence failure;
- V3-3 consumers receive only purpose-authorized, visibility-checked, world/template/profile-revision-bound fields. Self Profile affiliation is a Work Hub matching clue, never organization authority, and an Event identity summary never creates an event.
...
2. `P0 CONTACTS_V3_IDENTITY_AND_ROLE_CORE / CONTACTS-V3-0 THROUGH V3-3 FOUNDATION DONE / V3-4A THROUGH V3-4C DONE 2026-08-28 / V3-2C PERSON_PROFILE_UX IN_PROGRESS / V3-5 GATED`: profile-card structure, Persona Confirmation, bounded projections, and lifecycle safety are integrated. The individual-person page now foregrounds one stable contact ID, provides one Gallery-backed Appearance drill-down, and has one discoverable persona-import entry with pasted text and local TXT/Markdown/JSON support; joint user acceptance remains the active productization gate. Event/work-chain promotion and broader consumer adoption remain stopped.
...
10. `P1 PARTIAL_DONE / EVE-4C DONE 2026-08-14 / PLAYER_CONTEXT_V1_FOUNDATION_DONE 2026-08-15 / EVENT-PREP-1 DOC_ONLY_DONE 2026-08-27 / EVENT-PROJECTION-1 READ_ONLY_DONE 2026-08-27 / WORLD_SETTING_W2_DONE 2026-08-29 / WORLD-SEMANTIC-4 DONE 2026-08-31 / EVT-WORK-1 DONE 2026-08-29 / EVT-WORK-2 DONE 2026-08-29 / EVT-WORK-3 DONE 2026-08-30 / EVT-WORK-4 DONE 2026-08-30 / EVT-CHRONICLE-1 DONE 2026-08-30`: 4.14 retains the reusable Event Runtime and existing scoped event proofs while adding a world-neutral production Work Hub authority owner, ordinary organization-work loop, authority-bound `organization.work_schedule_change.v1` event family, revision-safe Calendar/Agenda/Map/Activity execution proof, a separate zero-model Chronicle projection over verified owner records, and one arbitrary-world restricted-place access proof. Work Hub validates exact world/Contacts/source revisions and owns membership/role evidence; Map owns place identity, entry, and the correlated access fact; Event Runtime owns the version-bound one-time settlement and audit. The S1 K-pop fixture remains isolated preview data, and modern K-pop, magic academy, and Tide Contract City share one runtime path. No SMS, downstream consequence, automatic attendance/completion, AI recall, background model operation, W3 switching, or EVE-5 expansion is promoted.
...
13. `ON_HOLD` until after the first usable product preview: personal R2/Worker, production push, Gallery/non-Book migration, World Setting W3 switching, hotspot decomposition, incremental typing, and secondary-module expansion.
14. `P2 PARTIAL_DONE / MJE-1_MJE-2_MJE-4_INTEGRATED / MJE-3_PRODUCTION_TRIGGER_SUSPENDED / PLACE_MEDIA_V1_ALL_106_SEOUL_PLACES_INTEGRATED_LOCAL`: 4.11 retains transport planning, lifecycle/checkpoints, Footprints IA, optional per-world authored-facility discovery, and governed place-detail media for all 106 Seoul places. One hundred four cards use exact-photo heroes, while CU BGF Headquarters Store and GS25 Gangnam Central use explicitly labeled same-brand representative heroes that do not claim the recorded facade. The generic checkpoint obstruction remains compatibility-tested but is not production-enabled. Active exploration, event-driven place reveal, candidate-place ownership, seven fictional generated reconstructions, transit topology, broader-city, and true-device stages remain gated.
15. `P2 PARTIAL_DONE / CALENDAR_DEPARTURE_READINESS_V1_DONE 2026-08-15 / CJA-1_DONE 2026-08-15 / CJA-2_DONE 2026-08-16 / CJA-3_DONE 2026-08-16 / CJA-4_DONE 2026-08-16 / CJA-5_DONE 2026-08-16 / CJA-6B_EVT-CHRONICLE-1_DONE 2026-08-30`: 4.12 now has Calendar authoring and occurrence views, the direct Calendar-to-Map departure vertical, hidden persisted orchestration, the separate Agenda Journey execution app, one absolute-time Activity Session, one midpoint-only low-impact Event Runtime family, and the bounded `生活志 / Chronicle` Diary Owner plus deterministic source-linked review projection. Appointment auto-entry, broader event families, media callers/richer companions, AI recall, and CJA-6C remain unimplemented.
16. `P1 INITIAL_SHELL_PORTFOLIO_DONE / SHP-1 THROUGH SHP-11 DONE 2026-08-24 / WORKPLACE_S1_PREVIEW_RETAINED / WORK_HUB_EVT-WORK-1_THROUGH_4_DONE 2026-08-30 / EVT-CHRONICLE-1_DONE 2026-08-30`: 4.16 retains thirteen accepted installed-App previews plus the native-system Notification Center. Workplace's fixture remains an explicit non-authoritative demo. Production Work Hub is an independent S2 owner with world-neutral organization authority, ordinary work decisions/status, backup/recovery, one native schedule-change event family, and revision-safe Calendar/Agenda/Map/Activity execution proof. Chronicle is an ordinary separate Home/App Store product for personal review and user-authored diary records. No model or K-pop-specific branch grants production membership, Calendar truth, travel evidence, completion, or diary fact authority. Conditional SMS remains separately gated.
