...
Status: `P0 IN_PROGRESS / CMG-00, CMG-01, AND CMG-03 DONE 2026-08-20 / DCF-05 NEXT`
...
1. `P0 IN_PROGRESS / CMG-00, CMG-01, AND CMG-03 DONE 2026-08-20`: continue 4.5-CMG from `DCF-05` on PC-B; `CMG-02` remains blocked until it completes, while `DCF-06` remains an independent PC-B test-stability repair.
