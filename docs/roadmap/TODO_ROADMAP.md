...
- 4.12 is `PARTIAL_DONE / CALENDAR_DEPARTURE_READINESS_V1_DONE 2026-08-15 / CJA-1_DONE 2026-08-15 / CJA-2_DONE 2026-08-16 / CJA-3_DONE 2026-08-16 / CJA-4_DONE 2026-08-16 / CJA-5_DONE 2026-08-16`: Calendar V3 supports Month/Week/Agenda and stable Map destinations; the hidden Schedule Orchestrator persists occurrence requests; the separate Agenda Journey app materializes or manually creates near-term execution plans; Activity Session owns absolute-time activity timing; and one midpoint-only low-impact Event Runtime family now supports silent `off` resolution or an inline Focus Companion text choice. Appointment auto-entry, media callers/richer companions, and Narrative Timeline remain unimplemented and separately gated.
...
Status: `PARTIAL_DONE / CALENDAR_DEPARTURE_READINESS_V1_DONE 2026-08-15 / CJA-1_DONE 2026-08-15 / CJA-2_DONE 2026-08-16 / CJA-3_DONE 2026-08-16 / CJA-4_DONE 2026-08-16 / CJA-5_DONE 2026-08-16`
...
Status: `P1 PARTIAL_DONE / EVE-0 DONE / EVE-1 DONE / EVE-2A DONE / EVE-2B DONE / EVE-2C DONE 2026-08-10 / EVE-3 DONE / EVE-4A TECHNICAL_SPIKE_COMPLETE / PRODUCT_ACCEPTANCE_WITHDRAWN / EVE-4B REFERENCE_VERTICAL_DONE 2026-08-14 / EVE-4C DONE 2026-08-14 / PLAYER_CONTEXT_V1_FOUNDATION_DONE 2026-08-15`
...
The detailed direction is `docs/architecture/PLAYER_CONTEXT_WORLD_EVOLUTION_AND_INFORMATION_PROPAGATION_ARCHITECTURE.md`. Only its `PLAYER_CONTEXT_V1_FOUNDATION` is implemented: a backward-compatible Contacts profile revision plus pure eligibility projection/evaluator and focused tests. It creates no EVE stage, new Store, route, Event Surface host, forum/news UI, claim/post persistence, clue system, random incident, model call, or closed-page simulation; all world-evolution and information-propagation work remains separately gated.
