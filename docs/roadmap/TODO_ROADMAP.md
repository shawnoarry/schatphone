...
Status: `P0 IN_PROGRESS / CMG-00 AND CMG-01 DONE 2026-08-20 / CMG-03 IN_PROGRESS ON PC-A`
...
| `CMG-03` | P0 | `IN_PROGRESS` | Remove the competing relationship truth from Chat prompt construction. Current relationship state appears exactly once and comes from Relationship Runtime; profile premise/classification remains context rather than a second current answer. | `CMG-01` | Contacts/relationship + Chat / PC-A (`SKY-20250212UBG`) |
...
1. `P0 IN_PROGRESS / CMG-03 IN_PROGRESS ON PC-A`: continue 4.5-CMG by removing competing Chat relationship truth. `DCF-05` still awaits PC-B and blocks `CMG-02`; `DCF-06` remains an independent PC-B test-stability repair.
