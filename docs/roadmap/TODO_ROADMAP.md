...
1. `P0 IN_PROGRESS / CMG-00, CMG-01, CMG-02, CMG-03, AND DCF-05 DONE 2026-08-20 / DCF-01, DCF-03, CMG-04, CMG-05, CMG-06, CMG-07, AND DCF-02 DONE 2026-08-21 / DCF-04 AND DCF-06 DONE 2026-08-22`: the first production gift shared-experience vertical is complete at `d8662cb`; `CMG-06` is complete at `f9f14f9`, `CMG-07` is complete at `d8b46fc`, `DCF-04` is complete at `26534bd` on the incoming-call focus boundary, and `DCF-06` is complete at `ec31855` on the image-bed tooling-test boundary. `CMG-08` remains the next separately assignable item and requires its own non-overlapping reservation.
