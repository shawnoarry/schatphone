...
- 4.14 is `P1 PARTIAL_DONE / EVE-2C DONE 2026-08-10`: Event remains a cross-module experience without a normal Home app. EVE-2A froze the reusable contracts and first K-pop archetype; EVE-2B added the durable reusable runtime; EVE-2C now adds Map V3 provenance/place sessions, exactly one Map host, explicit `Enter` / expansion, zero-token invitation/no-event paths, and the three-choice no-mutation production-arrival-briefing UI. EVE-3 through EVE-5 remain separately gated.
...
Status: `P1 PARTIAL_DONE / EVE-0 DONE / EVE-1 DONE / EVE-2A DONE / EVE-2B DONE / EVE-2C DONE 2026-08-10`
...
8. `P1 PARTIAL_DONE / EVE-2C DONE 2026-08-10`: 4.14 has landed the pure Event Surface Projection, frozen EVE-2A contracts/fixtures, EVE-2B reusable runtime, and the first Map/K-pop vertical slice with Map V3 provenance/place sessions, one explicit Map host, zero-token invitation/no-event paths, explicit entry/expansion, three no-mutation choices, fail-closed geographic/canvas anchors, stacking, layer coexistence, and return context. EVE-3, EVE-4, and EVE-5 remain separately gated.
