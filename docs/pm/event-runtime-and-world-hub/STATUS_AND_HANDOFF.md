...
4. Deepen the landed Chat social-event review seam: tune runtime greeting cooldown/cap policy, add richer scheduling only when explainable, and keep high-risk role-initiated friend/block/refusal changes review-first in World Hub.
