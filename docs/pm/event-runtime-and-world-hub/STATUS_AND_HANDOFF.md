...
5. deeper generated social behavior is still incomplete: AI/source trigger wiring, broader social-event types, scheduling, and cooldown tuning should build on the landed review seam instead of writing directly to Chat or relationship runtime.
...
4. Deepen the landed Chat social-event review seam: connect real AI/runtime proposal sources, tune cooldown/cap policy, and keep high-risk role-initiated friend/block/refusal changes review-first in World Hub.
