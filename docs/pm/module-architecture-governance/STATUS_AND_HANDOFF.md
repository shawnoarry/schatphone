...
| Source branch, base, and worktree | `main`; CMG-06 reservation base `d1cfbab179e3197e9823e50f7cd73b1b978d23e9`; controller commit `f9f14f9`; `D:\github\schatphone` |
...
| Integration state | `CMG-06 DONE 2026-08-21`; controller commit `f9f14f9` is on local `main` |
