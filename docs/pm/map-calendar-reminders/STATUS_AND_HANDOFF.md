...
17. the final place-media composition remains open until the intended photo/fallback set is adapted and compared. Separate product decisions are still required for a distinct long description and private user note; Event invitation placement and keyboard-initiated focus policy remain research items.
