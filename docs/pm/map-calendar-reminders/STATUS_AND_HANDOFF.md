...
remaining 53 candidates can stay un-downloaded until the next acquisition round.
...
16. place media covers thirteen Seoul places with 31 reviewed real-photo derivatives plus one fictional fallback; expanding reviewed photography across the remaining 93 Seoul places, adding any generated reconstruction, user-selected Gallery media, periodic license revalidation, and true-device image/network evidence remain separate work.
