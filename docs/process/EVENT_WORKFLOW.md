...
32. Optional event permission, random-event intensity, and presentation mode are separate controls. Disabling optional events cannot remove deterministic schedule, journey, activity, deadline, or safety behavior.
