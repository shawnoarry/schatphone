...
28. Next recommended slice: either connect Phone missed-call records into Calendar cues, or add Wallet source badges/filters for Chat-origin ledger entries.
    下一推荐切片：可将 Phone 未接来电继续接入 Calendar 线索，或为 Wallet 中来自 Chat 的流水增加来源徽标/筛选。
29. Keep deferring visual redesign and broad store rewrites.
