...
| --- | ---: | --- |
| `src/views/ChatView.vue` | 6663 | still the largest maintainability hotspot; active-thread, service-thread display, and message-edit display-state seams are now extracted |
