...
describe('Contacts profile template entity UI', () => {
  ...
  test('classifies persona prose into four review buckets without changing the profile', async () => {
    ...
    ).toContain('review draft only')
    expect(wrapper.find('[data-testid="contacts-save-persona-confirmation"]').exists()).toBe(false)
    expect(wrapper.find('[data-testid^="contacts-persona-accept-"]').exists()).toBe(false)
