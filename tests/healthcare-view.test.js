...
describe('Ondam Care Healthcare S1 shell', () => {
  ...
  test('renders an ordinary care discovery loop with explicit simulation boundary', async () => {
    ...
    expect(wrapper.get('[data-required-asset="shared/app-icons/ondam-care-app-icon-v2.png"]')).toBeTruthy()
    expect(wrapper.get('[data-required-asset="healthcare/ip/ondam-care-welcome-hero-v1.webp"]')).toBeTruthy()
  ...
  test('care overview exposes appointments and reports as first-class pages', async () => {
    ...
    expect(wrapper.get('[data-required-asset="healthcare/ip/ondam-care-report-scene-v1.webp"]')).toBeTruthy()
    ...
    expect(wrapper.get('[data-required-asset="healthcare/ip/ondam-care-appointment-scene-v1.webp"]')).toBeTruthy()
    wrapper.unmount()
  })
  ...
  test('filters services and recovers from a deterministic empty state', async () => {
    ...
    expect(wrapper.get('[data-required-asset="healthcare/ip/ondam-care-search-magnifier-v1.webp"]')).toBeTruthy()
