...
const APP_STORE_ENTRIES = [
  ...
  {
    id: WORKPLACE_HOME_APP_ID,
    route: WORKPLACE_ROUTE,
    labelZh: '工作台',
    labelEn: 'Work Hub',
    categoryZh: '效率',
    categoryEn: 'Productivity',
    descZh: '查看团队频道、工作确认、排期提案与组织所属。',
    descEn: 'Review team channels, work confirmations, schedule proposals, and organization membership.',
  },
  {
    id: FANDOM_HOME_APP_ID,
    route: FANDOM_ROUTE,
    labelZh: '星集',
    labelEn: 'Aster',
    categoryZh: '社交',
    categoryEn: 'Social',
    descZh: '浏览艺人社区与公开日程，阅读平台订阅消息预览，并从工作台申请艺人入口。',
    descEn: 'Browse artist communities and public schedules, preview platform subscription notes, and apply for artist access through Work Hub.',
  },
  {
    id: TICKETS_HOME_APP_ID,
    route: TICKETS_ROUTE,
    labelZh: '入场',
    labelEn: 'GATE',
    categoryZh: '娱乐',
    categoryEn: 'Entertainment',
    descZh: '发现演出、电影与展览，查看开售状态并保存本机入场意向草稿。',
    descEn: 'Discover concerts, film, and exhibitions, inspect sale states, and save local admission-intent drafts.',
  },
  {
    id: TRAVEL_HOME_APP_ID,
    route: TRAVEL_ROUTE,
    labelZh: '漫泊',
    labelEn: 'ROAM',
    categoryZh: '旅行',
    categoryEn: 'Travel',
    descZh: '发现目的地与住宿，查看房型状态并保存本机住宿意向。',
    descEn: 'Discover destinations and stays, inspect room-source states, and save local stay-intent drafts.',
  },
  {
    id: INTERCITY_HOME_APP_ID,
    route: INTERCITY_ROUTE,
    labelZh: '联程',
    labelEn: 'VIA',
    categoryZh: '交通',
    categoryEn: 'Transport',
    descZh: '比较铁路、航班、长途巴士与渡轮班次，并保存本机出行意向。',
    descEn: 'Compare rail, flight, coach, and ferry services and save local travel intents.',
  },
  {
    id: CREATOR_RIGHTS_HOME_APP_ID,
    route: CREATOR_RIGHTS_ROUTE,
    labelZh: '谱权',
    labelEn: 'CREDO',
    categoryZh: '创作',
    categoryEn: 'Creator',
    descZh: '整理作品、参与角色、权利份额、版税结算单与年度申报草稿。',
    descEn: 'Organize works, roles, rights shares, royalty statements, and annual declaration drafts.',
  },
  {
    id: PARCEL_HOME_APP_ID,
    route: PARCEL_ROUTE,
    labelZh: '递送',
    labelEn: 'POSTA',
    categoryZh: '生活',
    categoryEn: 'Lifestyle',
    descZh: '查看包裹状态、递送消息，并准备本机寄件草稿。',
    descEn: 'Review parcel states and delivery updates, and prepare local sending drafts.',
  },
  {
    id: CAREER_HOME_APP_ID,
    route: CAREER_ROUTE,
    labelZh: '机会',
    labelEn: 'NEXT',
    categoryZh: '职业',
    categoryEn: 'Career',
    descZh: '发现工作、试镜与邀约，收藏机会并准备本机申请材料。',
    descEn: 'Discover jobs, auditions, and invitations, then prepare local application materials.',
  },
  {
    id: 'app_phone',
    route: '/phone',
  ...
  {
    id: CHRONICLE_HOME_APP_ID,
    route: CHRONICLE_ROUTE,
    labelZh: '生活志',
    labelEn: 'Chronicle',
    categoryZh: '生活',
    categoryEn: 'Life',
    descZh: '按日期回顾已经确认的生活轨迹，并写下只属于你的记录。',
    descEn: 'Review confirmed life traces by date and keep notes that remain yours.',
  },
  {
    id: 'app_reminders',
    route: '/reminders',
