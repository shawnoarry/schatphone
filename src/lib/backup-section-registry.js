...
export const LEGACY_V2_BACKUP_SECTION_REGISTRY = freezeRegistry([
  ...
  { id: 'schedule-orchestrator-legacy-compatibility', owner: 'Schedule Orchestrator', coverage: 'required_legacy_compatibility', dataClassIds: ['schedule-orchestrator.materialization-decisions'], payloadFields: [{ path: 'calendar', shape: 'object' }] },
  ...
  {
    id: 'world-suite-inventory-known-gap',
    owner: 'World Suite',
    coverage: 'known_gap',
    dataClassIds: ['world-suite.installation-inventory'],
    payloadFields: [],
    reason: 'Legacy v2 exports predate World Suite installation evidence and restore it as an empty inventory.',
  },
  {
    id: 'mini-scene-known-gap',
    owner: 'Mini Scene',
    coverage: 'known_gap',
    dataClassIds: ['mini-scene.artifacts-and-policies'],
    payloadFields: [],
    reason: 'Legacy v2 exports predate Mini Scene artifacts, interaction audit, profile bindings, and module presentation policies.',
  },
