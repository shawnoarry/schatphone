...
export const APP_SKIN_TARGETS = Object.freeze([
  ...
  Object.freeze({ appId: 'app_music', scope: 'music', labelZh: '音乐', labelEn: 'Music' }),
  ...
  Object.freeze({ appId: 'app_workplace', scope: 'workplace', labelZh: '工作台', labelEn: 'Work Hub' }),
  Object.freeze({ appId: 'app_fandom', scope: 'fandom', labelZh: '星集', labelEn: 'Aster' }),
  Object.freeze({ appId: 'app_tickets', scope: 'tickets', labelZh: '入场', labelEn: 'GATE' }),
  Object.freeze({ appId: 'app_travel', scope: 'travel', labelZh: '漫泊', labelEn: 'ROAM' }),
  Object.freeze({ appId: 'app_intercity', scope: 'intercity', labelZh: '联程', labelEn: 'VIA' }),
  Object.freeze({ appId: 'app_creator_rights', scope: 'creator_rights', labelZh: '谱权', labelEn: 'CREDO' }),
  Object.freeze({ appId: 'app_parcel', scope: 'parcel', labelZh: '递送', labelEn: 'POSTA' }),
  Object.freeze({ appId: 'app_career', scope: 'career', labelZh: '机会', labelEn: 'NEXT' }),
