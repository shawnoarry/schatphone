...
1. Immediate: `P0-C2` (rich-message lane hardening + UX polish).  
立即：`P0-C2`（富消息链路加固与交互打磨）。
2. Then: `P0-C3/P0-C4` Gallery asset center + role-pack binding reuse.  
随后：`P0-C3/P0-C4` 相册素材中心与角色素材包绑定复用。
3. Optional: streaming-state extension and truth-policy tuning based on playtest transcripts.  
可选：结合实测推进流式状态扩展与真值策略调参。
